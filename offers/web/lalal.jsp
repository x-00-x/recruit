...
<div id="tn-content" >
    ...
    <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
            <div class="tn-box-content tn-widget-content tn-corner-all">
                <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <span><a class="tn-button it-button-video" href="http://www.itoffer.cn/Company/131#moreVideos"></a></span> <a href="recruit/company.html" target="_blank"> <img src="images/635170123249913750.jpg" width="990"> </a> </div>
            </div>
        </div>
    </div>
    <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
            <div class="tn-box-content tn-widget-content tn-corner-all">
                <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <a href="recruit/company.html" target="_blank"> <img src="images/635086129655240312.jpg" width="990"> </a> </div>
            </div>
        </div>
    </div>
    <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
            <div class="tn-box-content tn-widget-content tn-corner-all">
                <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <a href="recruit/company.html" target="_blank"> <img src="images/635508801853812771.jpg" width="990"> </a> </div>
            </div>
        </div>
    </div>
    <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
            <div class="tn-box-content tn-widget-content tn-corner-all">
                <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <a href="recruit/company.html" target="_blank"> <img src="images/635386133707515461.jpg" width="990"> </a> </div>
                <div class="it-home-present">
                    ...
                    <div class="it-present-text" style="padding-left:185px;">
                        <div class="it-line01 it-text-bom">
                            ...
                            <p class="it-line01 it-text-explain"> <span class="tn-icon it-home-arrow"></span> <a href="job.html" target="_blank" title=".NET软件开发工程师">.NET软件开发工程师</a> </p>
                    ...
                    <div class="it-present-text">
                        <div class="it-line01 it-text-bom">
                            <p class="it-text-tit">职位</p>
                            <p class="it-line01 it-text-explain"> <span class="tn-icon it-home-arrow"></span> <span class="tn-helper-right tn-action"> <a href="job.html" target="_blank" class="tn-button tn-corner-all tn-button-text-only tn-button-semidlong"> <span class="tn-button-text">更多职位</span> </a> </span> <a href="job.html" target="_blank" title=".NET软件开发工程师">.NET软件开发工程师</a> </p>
    ...
    <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
            <div class="tn-box-content tn-widget-content tn-corner-all">
                <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <span><a class="tn-button it-button-video" href="#"></a></span> <a href="company.html" target="_blank"> <img src="images/635061323749843750.jpg" width="990"> </a> </div>
            </div>
        </div>
    </div>
    <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
            <div class="tn-box-content tn-widget-content tn-corner-all">
                <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <a href="recruit/company.html" target="_blank"> <img src="images/635508636209238443.jpg" width="990"> </a> </div>
                <div class="it-home-present">
    ...
    <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
            <div class="tn-box-content tn-widget-content tn-corner-all">
                <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <a href="recruit/company.html" target="_blank"> <img src="images/635508802169230812.jpg" width="990"> </a> </div>
            </div>
        </div>
    </div>
    <div class="tn-grid">
    ...
    <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
            <div class="tn-box-content tn-widget-content tn-corner-all">
                <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <a href="recruit/company.html" target="_blank"> <img src="images/635084591046656250.jpg" width="990"> </a> </div>
            </div>
        </div>
    </div>
    <div class="tn-grid">
