...
<div class="resume_con">
    ...
    <div class="resume_main">
    	<!--左边-->
		<form action="${appPath}/ResumeBasicInfoServlet?method=add" method="post">
				...
				<div class="table_style">
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8"><input type="text" name="name" value="冯娟娟"></td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8"><input type="radio" name="gender" value="男" checked>男<input type="radio" name="gender" value="女">女</td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8"><input type="text" name="birthday" value="2005-09-09"></td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8"><input type="text" name="phone" value="13333333333333"></td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8"><input type="text" name="email" value="test@test.com"></td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8"><input type="text" name="intension" value="软件开发"></td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8"><input type="text" name="experience" value="应届毕业生"></td>
					  </tr>
					</table>
					<div class="he"></div>
