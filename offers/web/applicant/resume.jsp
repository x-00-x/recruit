<%@ page import="com.qst.bean.ResumeBasicInfo" %>
<%@ page import="java.text.SimpleDateFormat" %>
<%@ page import="static sun.misc.MessageUtils.out" %>
<%@ page import="com.qst.utils.DateUtils" %>
...
<%
	ResumeBasicInfo resumeBasicInfo=(ResumeBasicInfo)request.getAttribute("resumeBasicInfo");
%>
    ...
    <div class="resume_main">
	    ...
	    <div class="resume_left">
			<div class="resume_title">
				...
				<div class="btn"><a href="${appPath}/ResumeBasicInfoServlet?method=findById&resumeId=${resumeBasicInfo.qid}">修改</a></div>
			</div>
				...
				<div class="table_style">
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8">${resumeBasicInfo.name}<%--<%=resumeBasicInfo.getName()%>--%></td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8">${resumeBasicInfo.gender}<%--<%=resumeBasicInfo.getGender()%>--%></td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8"><fmt:formatDate value="${resumeBasicInfo.birthday}" pattern="yyyy-MM-dd"/><%--<%=resumeBasicInfo.getBirthday()%>--%>
					  	  <%--<%=DateUtils.format(resumeBasicInfo.getBirthday())%>--%>
					    </td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8">${resumeBasicInfo.phone}<%--<%=resumeBasicInfo.getPhone()%>--%></td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8">${resumeBasicInfo.email}<%--<%=resumeBasicInfo.getEmail()%>--%></td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8">${resumeBasicInfo.intension}<%--<%=resumeBasicInfo.getIntension()%>--%></td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8">${resumeBasicInfo.experience}<%--<%=resumeBasicInfo.getExperience()%>--%></td>
					  </tr>
					</table>
					<div class="he"></div>
				</div>
				<div style="float:right" class="uploade">
					<%if(resumeBasicInfo.getHeadShot()!=null){%>
							<img width="100px" height="100px" src="${appPath}/applicant/images/<%=resumeBasicInfo.getHeadShot()%>">
					<%}else{%>
							<img width="100px" height="100px" src="${appPath}/images/person_img.jpg">
					<%}%>
					<div align="center">
